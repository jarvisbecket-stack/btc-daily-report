...
class BitcoinDailyReport:
    ...
    def fetch_youtube_insights(self):
        ...
        try:
            ...
            # These would be dynamic based on trending BTC videos
            video_insights = [
                "Market analysis shows Bitcoin consolidating above key support levels.",
                "Technical indicators suggest potential breakout in either direction.",
                "Institutional interest remains strong despite recent volatility."
            ]
            
            return video_insights
        except Exception as e:
            return ["YouTube insights temporarily unavailable."]
